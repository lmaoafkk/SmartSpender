...
# Get the app directory path relative to this file
APP_DIR = Path(__file__).parent.parent

template_env = Environment(loader = FileSystemLoader(APP_DIR / "templates"), )
template_env.globals['get_flashed_messages'] = get_flashed_messages
templates = Jinja2Templates(env=template_env)
static_files = StaticFiles(directory=str(APP_DIR / "static"))
